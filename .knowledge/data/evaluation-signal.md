...
---
Session-computed judgement of how a concept:player-slot is doing, delivered with concept:sight and recorded for analysis.
...
defined_by: the game, like every other content decision, see rule:sight-content-owned-by-game
