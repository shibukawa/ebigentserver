...
---
Operator-declared retention and access rules govern recorded sights, actions, identities, and training exports.

```yaml
classification:
  - player identity and free form agent output are sensitive
  - sights may reveal private role or team information
requirements:
...
logging_boundary: api:runtime-observability excludes raw credentials and sights by default
