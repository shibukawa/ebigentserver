...
why: the endpoint exposes full concept:world-state, which defeats policy:sight-scoped-information and rule:analysis-restricted-to-visible-fields for anyone who reaches it
