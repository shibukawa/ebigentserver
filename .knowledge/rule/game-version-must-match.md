---
id: rule:game-version-must-match
type: rule
title: Game Version Must Match Exactly
---
Mismatched data:game-version between peers is a hard connection error, not a negotiation.
