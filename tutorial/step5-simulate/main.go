// Command step5-simulate is the last of the board-game tutorial.
//
//	go run ./tutorial/step5-simulate             # records into ./corpus
//	go run ./tutorial/step5-simulate -corpus ""  # records nothing
//
// The opponent is still generated Go, but the corpus behind it was
// recorded against a rotating cast rather than a coin, and it took half
// as many games to get there.
//
// The other half of this step ships as measurements rather than as
// code. distill/teacher.go holds a minimax player that never loses, and
// the tests report what happens when it is used as the teacher: not very
// much. A perfect player in a solved game chooses arbitrarily among
// equally good moves, and a predicate can only name reasons.
package main
